    ...
    const renderHomesNSWPath = (): ReactNode => (
        <div className="space-y-4">
            ...
            <TimelineItem
                ...
                icon={CheckCircle}
                content={                    <p>
                        <Clock className="inline mr-2" />June 11, 2025
                    </p>}
                cumulativeTime="6 weeks"
            />
            <TimelineItem
                title="Phase 3: Concept Shortlisting"
                description="Our committee will evaluate and shortlist the prospective ideas. Selected teams will be notified to prepare their strategy presentations."
                icon={FileSearch}
                content={
                    <p>
                        <Clock className="inline mr-2" />June 11, 2025
            ...
            />
                        <TimelineItem
                title="Phase 4: Idea Presentation"
                description="Present your selected idea to judges via provided meeting link. Be prepared to discuss technical feasibility and market fit eligibility."
                icon={FileSearch}
                content={
                    <p>
                        <Clock className="inline mr-2" />June 20, 2025
                    </p>
                }
                cumulativeTime="14 weeks"
            />
                ...
                content={
                    <p>
                        <Clock className="inline mr-2" />July 10, 2025 (Afternoon)
                    </p>
                }
                cumulativeTime="14 weeks"
            />
                ...
                content={
                    <p>
                        <Clock className="inline mr-2" />July 11, 2025 (Afternoon)
                    </p>
                }
                cumulativeTime="14 weeks"
            />
